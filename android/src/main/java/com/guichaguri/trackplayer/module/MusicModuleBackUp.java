 ...
 * @author Guichaguri
 */
public class MusicModuleBackUp extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    public MusicModuleBackUp(ReactApplicationContext reactContext) {
        super(reactContext);
    }
