...
function addJonathan(tracks) {
    return TrackPlayer.addJonathan(tracks);
}
...
module.exports.addJonathan = addJonathan;
...
module.exports.setMode = TrackPlayer.setMode;
...
module.exports.getMode = TrackPlayer.getMode;
